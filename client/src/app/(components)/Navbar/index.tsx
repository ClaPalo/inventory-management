            ...
            <div className="flex justify-between items-center gap-5">
                ...
                <div className="relative">
                    <input
                        ...
                        className="pl-10 pr-4 py-2 w-50 md:w-60 border-2 border-gray-200 bg-white rounded-lg focus:outline-none focus:border-blue-500"
                    />
            ...
            <div className="flex justify-between items-center gap-5">
                <div className="hidden md:flex justify-between items-center gap-5">
                    ...
                    <div className="flex items-center gap-3 cursor-pointer">
                        <Image
                            src="https://s3-inventorymanagement-cpalos2.s3.us-east-2.amazonaws.com/profile.jpg"
                            alt="profile"
                            width={50}
                            height={50}
                            className="rounded-full h-full object-cover"
                        />
                        <span className="font-semibold">Claudio Paloscia</span>
                    </div>
                </div>
                <Link href="/settings">
                    <Settings
